...
(function () {
  ...
  const STRINGS = {
    de: {
      ...
      vizGraphvizFail:
        'Visualisierung konnte nicht erzeugt werden (Graphviz-Service nicht erreichbar).',
      ...
      rrVizGraphvizFail:
        'Restrisiko-Visualisierung konnte nicht erzeugt werden (Graphviz-Service nicht erreichbar).',
      approval: 'Freigabe',
    ...
    en: {
      ...
      rrVizGraphvizFail:
        'Residual risk visualisation could not be created (Graphviz service unreachable).',
      approval: 'Approval',
