...
(function () {
    ...
    const STRINGS = {
        de: {
            ...
            vizGraphvizFail: 'Visualisierung konnte nicht erzeugt werden (lokales Graphviz und Online-Dienste nicht verfügbar).',
            ...
            rrVizGraphvizFail: 'Restrisiko-Visualisierung konnte nicht erzeugt werden (lokales Graphviz und Online-Dienste nicht verfügbar).',
            approval: 'Freigabe',
        ...
        en: {
            ...
            vizGraphvizFail: 'Visualisation could not be created (local Graphviz and online services unavailable).',
            ...
            rrVizGraphvizFail: 'Residual risk visualisation could not be created (local Graphviz and online services unavailable).',
            approval: 'Approval',
