  ...
  "strideCategories": [
    {
      ...
      "description_en": "Can an attacker or foreign device impersonate a trusted participant to gain access? (e.g. a forged service tool)."
    },
    {
      "id": "T",
      ...
      "description_en": "Can data, parameters, configurations or firmware on the device or in transit be changed without authorisation?"
    },
    {
      "id": "R",
      ...
      "description_en": "Can critical actions be performed without us later being able to prove who did them? (Missing or tamperable logs)."
    },
    {
      "id": "I",
      ...
      "description_en": "Can sensitive information (e.g. passwords, recipes, customer data or know-how) be read by unauthorised parties?"
    },
    {
      "id": "D",
      ...
      "description_en": "Can the system be sabotaged or overloaded so that it stops working or becomes sluggish? (e.g. blocking the controller)."
    },
    {
      "id": "E",
      ...
      "description_en": "Can a low-privilege user (e.g. guest/operator) obtain permissions they should not have (e.g. admin/service rights)?"
    }
  ]
};
