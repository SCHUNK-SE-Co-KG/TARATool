...
| P-20  | Audit-Trail-Kommentar bei jedem Board-Status-Wechsel; PO-Freigabe-Keywords: `PO-OK`, `Freigabe erteilt`, `freigegeben`, `akzeptiert`, `Accepted`, `Ok`/`OK`                                                                                                                                                                                                                                                                                                                                       | **GitHub Actions (Issue-Kommentar)**              |
...
| P-24  | **Epic-Sync-Pflicht**: Wird eine Story mit `Bezug: #<Epic-Nr>` angelegt (initial oder als Folge-Story waehrend laufender Epic-Bearbeitung), muss der Dev-Agent im gleichen Arbeitsschritt das Epic-Issue-Body um die neue Story ergaenzen (Checkliste "Enthaltene Stories"). Vor dem Schliessen eines Epics prueft der Dev-Agent, dass alle Issues mit `Bezug: #<Epic-Nr>` (offen oder geschlossen) auch tatsaechlich im Epic-Body gelistet sind – fehlt eine Story, wird sie zuerst nachgetragen | Manuell (Dev-Agent-Pflicht)                       |
...
> **Nicht automatisierbar:** P-01, P-02, P-05, P-09, P-10, P-11, P-16, P-17, P-18, P-21, P-22, P-23, P-24
